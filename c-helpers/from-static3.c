...
void check_torals(matrix* m, _index r)
{ _index i;
  if (m->ncols!=r+1)
...
*/
void check_Ww(vector* ww, _index s)
...
void check_Wws(matrix* m, _index s)
...
object grp_select_grp_int(g,n) object g; _index n;
{ object result;
  _index i = n;
...
object groupmake(char lietype,_index rank)
{ object result;
