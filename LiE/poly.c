...
#ifdef __STDC__
static void error_nvars(_index n1,_index n2);
#endif
...
{ _index i,j,k; entry len=a->ncols; cmp_tp cmp; poly* result;
...
{ _index nrows = b->nrows, ncols = b->ncols;
  entry i,j;
...
{ _index r1= p1->ncols, r2=p2->ncols, n1=p1->nrows,
      n2=p2->nrows;
...
poly *Mul_pol_pol(p1,p2)
    poly *p1, *p2;
{
    _index ncols1 = p1->ncols, ncols2 = p2->ncols,
    nrows1 = p1->nrows, nrows2 = p2->nrows;
    _index nrows = nrows1 * nrows2;
    poly *result, *garbage;
    _index i,j,k = 0,l;
