...
/*matrix* mat_id(_index size);*/                    /* implemented - static/static1.c */
...
_index int_mul_vec_vec(vector *a, vector *b);       /* implemented */
...
object groupmake(char lietype,_index rank);           /* implemented */
